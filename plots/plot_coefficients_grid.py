...
def process_and_plot_pair(
    ...
    if showtite:
        ...
        ax.set_title(title, fontsize=20, y=1.04, pad=5, x=x_shift, loc="right")
        """
        ax2.text(
            midpoint_x,
            0.88,
...
fig.text(0.5, 0.03, "Steps", ha="center", fontsize=20)
plt.savefig(f"coefficients_grid.pdf", dpi=300, bbox_inches="tight")
